...
_targets = ["Sofia Radar Station","Research Facility","Limni","Paros","Molos","Delfinaki Outpost","Nidasos Woodlands","Sofia Powerplant","Gatolia Solar Farm","Molos Airfield","Ghost Hotel","Kalithea"];
