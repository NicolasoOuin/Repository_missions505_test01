...
//-------------------- 3. SPAWN CREW
	...
	[(units _priorityGroup)] call QS1_fnc_setSkill4;
...
//-------------------- 5. SPAWN FORCE PROTECTION
	...
	_enemiesArray = [priorityObj1] call QS1_fnc_PTenemyEAST;
...
{ [_x] spawn QS1_fnc_SMdelete } forEach [_enemiesArray,_unitsArray];
