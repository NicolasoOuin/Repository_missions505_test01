...
_sel = [_textValue] call CHVD1_fnc_selTerrainQuality;
if (CHVD1_allowNoGrass) then {
...
_listboxCtrl ctrlSetEventHandler ["LBSelChanged",
	format ["[_this select 1, '%1', %2] call CHVD1_fnc_onLBSelChanged", _varType, _textCtrl]
];
