...
//---------- COMMON
	...
	[(units _IRGsniperGroup)] call QS1_fnc_setSkill4;
	[(units _SMvehPatrol)] call QS1_fnc_setSkill3;
	[(units _SMaaPatrol)] call QS1_fnc_setSkill4;

//---------- GARRISON FORTIFICATIONS

	{
		_newGrp = [_x] call QS1_fnc_garrisonFortFIA;
